...
void StartScene::Start()
{
	...
	m_pStartLabel = new Label("Sujain Reymond", "Consolas", 80, blue, glm::vec2(400.0f, 40.0f));
	m_pStartLabel->SetParent(this);
	AddChild(m_pStartLabel);

	m_pInstructionsLabel = new Label("101311264", "Consolas", 40, blue, glm::vec2(400.0f, 120.0f));
